<?php
	...
	class DateUnitTest extends TestCase {
		...
		// =========================================================================
		// ($this->intervalParser)->parse — "now" and non-interval strings
		// =========================================================================
		...
		public function testUnrecognisedStringReturnsNull(): void {
			$this->assertNull(($this->intervalParser)->parse('yesterday'));
		}
		...
		public function testBareNumberReturnsNull(): void {
			$this->assertNull(($this->intervalParser)->parse('42'));
		}
		...
		public function testUnknownUnitReturnsNull(): void {
			$this->assertNull(($this->intervalParser)->parse('6 fortnights'));
		}
		...
		public function testExtraTokensReturnNull(): void {
			$this->assertNull(($this->intervalParser)->parse('6 days ago'));
		}
		
		public function testLeadingGarbageReturnsNull(): void {
			$this->assertNull(($this->intervalParser)->parse('about 6 days'));
		}

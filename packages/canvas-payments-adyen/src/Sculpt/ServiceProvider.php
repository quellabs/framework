<?php
	...
	/**
	 * Service Provider for Adyen payment engine integration
	 * Registers Adyen-related commands with the Sculpt application
	 */
	class ServiceProvider extends \Quellabs\Sculpt\ServiceProvider {
		...
		public function register(Application $application): void {
			// Register all Adyen-related commands with the application

...
Canvas includes a powerful visual debug bar that appears at the bottom of your web pages during development. It provides essential insights into your application's performance, database queries, request data, and more.

### Enabling the Debug Bar

The debug bar is controlled by a dedicated configuration file:
...
You can also control it through your main application configuration:
...
use Quellabs\Canvas\Inspector\DebugPanelInterface;
...
Configure custom panels in the debug bar configuration:

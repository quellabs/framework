<?php
	...
	class ComposerInstalledLoader {
		...
		/**
		 * @var array<string, array<string, array<string, mixed>>> Cache of parsed installed files
		 */
		 ...
		 * @return array<string, array<string, mixed>> Parsed installed packages data or null on failure
		 */
		 ...
		 * @return array<string, array<string, mixed>> Parsed extra data as "package-name" => extra_block
		 */

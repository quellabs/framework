<?php
	...
	class ComposerInstalledLoader {
		...
		/**
		 * @var array<string, array<string, mixed>|null> Cache of parsed installed files
		 */
		 ...
		 * @return array<string, array<string, mixed>>|null Parsed installed packages data or null on failure
		 */

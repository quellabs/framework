<?php
	...
	/**
	 * Service Provider for PayPal payment engine integration
	 * Registers PayPal-related commands with the Sculpt application
	 */
	class ServiceProvider extends \Quellabs\Sculpt\ServiceProvider {
		...
		public function register(Application $application): void {
			// Register all PayPal-related commands with the application

<?php
	...
	return [
		...
		// The URL your frontend/backend can hit to manually refresh a parcel's status.
		// Useful for reconciling missed webhooks or powering a "refresh tracking" button in an admin UI.
		// This is an internal endpoint — it is not called by SendCloud.
		'refresh_url'       => 'https://example.com/shipments/sendcloud/refresh/{parcelId}',

<?php
	...
	/**
	 * Service Provider for Mollie payment engine integration
	 * Registers Mollie-related commands with the Sculpt application
	 */
	class ServiceProvider extends \Quellabs\Sculpt\ServiceProvider {
		...
		public function register(Application $application): void {
			// Register all Mollie-related commands with the application

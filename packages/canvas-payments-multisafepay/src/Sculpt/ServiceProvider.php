<?php
	...
	/**
	 * Service Provider for MultiSafepay payment engine integration
	 * Registers MultiSafepay-related commands with the Sculpt application
	 */
	class ServiceProvider extends \Quellabs\Sculpt\ServiceProvider {
		...
		public function register(Application $application): void {
			// Register all MultiSafepay-related commands with the application

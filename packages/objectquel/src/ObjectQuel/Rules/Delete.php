<?php
	 ...
	 *
	 * $directives is threaded through so `delete` can carry the same
	 * `@ignoreSoftDelete true` directive `retrieve` uses (see QuelToSQLDelete).
	 */
	class Delete {
		 ...
		 * @param array<string, mixed> $directives Compiler directives parsed ahead of this statement

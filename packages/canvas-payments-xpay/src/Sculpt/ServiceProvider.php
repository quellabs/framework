<?php
	...
	/**
	 * Service Provider for XPay payment engine integration
	 * Registers XPay-related commands with the Sculpt application
	 */
	class ServiceProvider extends \Quellabs\Sculpt\ServiceProvider {
		...
		public function register(Application $application): void {
			// Register all XPay-related commands with the application
